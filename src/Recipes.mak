...
define recipe-tex-to-beamer-presentation
	@echo [usefl] Prepending TEX file: $(@) from $(firstword $(^))
	@$(REPORTER) wrap \
	--wrap-in=$(firstword $(^)) \
	--wrap-out=$(@) \
	--wrap-before="%% AUTOGENERATED documentclass from $(firstword $(^))" \
	--wrap-before="\\documentclass[aspectratio=1610]{beamer} " \
    --wrap-before="%% Values include:  1610  169  149  54  43 and 32. " \
	--wrap-before="\\setbeameroption{hide notes} " \
	--wrap-before=" " \
	--wrap-before=" "
endef

define recipe-tex-to-beamer-handout
	@echo [usefl] Prepending TEX file: $(@) from $(firstword $(^))
	@$(REPORTER) wrap \
	--wrap-in=$(firstword $(^)) \
	--wrap-out=$(@) \
	--wrap-before="%% AUTOGENERATED documentclass from $(firstword $(^))" \
	--wrap-before="\\documentclass[aspectratio=1610,handout]{beamer} " \
    --wrap-before="%% Values include:  1610  169  149  54  43 and 32. " \
	--wrap-before="\\usepackage{pgfpages} % \n" \
	--wrap-before="\\pgfpagesuselayout{ 2 on 1 }[letterpaper\, border shrink=5mm %\n"\
	--wrap-before=" " \
	--wrap-before=" "
endef
...
define recipe-sql-to-csv-egrprod
	@echo [usefl] Query to csv file: $(@)
